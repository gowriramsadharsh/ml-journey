...
# True function (some terms matter, some don't)
y = (
    3
    + 2*x1
    + 1.5*x2
...
alpha = 0.01
lambda1 = 0.05   # L1 strength
lambda2 = 0.05   # L2 strength
epochs = 5000
m = n

# -------------------------
# 5️⃣ Elastic Net Gradient Descent
# -------------------------
